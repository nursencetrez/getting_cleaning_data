...
Merge train and test data sets into merged data set so-called Allmerged.
Add the correct names of variables with features information.
Select just the measures with mean and standard deviation, subset assigning as subset_meanstd.
Transform activity column into factor and change the levels with the names.
From the df1 created a tidyData with the average of each variable for each activity and each subject.
Export the tidyData in text format.
